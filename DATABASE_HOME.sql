...
--for Linux
( NAME = N'HOME', FILENAME = N'/var/opt/mssql/HOME.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'HOME_log', FILENAME = N'/var/opt/mssql/HOME_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
